...
export interface AnonymityTiers extends BaseContract {
  ...
  getFunction(
    nameOrSignature: "anonymousRecords"
  ): TypedContractMethod<
    [arg0: string],
    [
      [bigint, bigint, boolean] & {
  ...
  >;
  getFunction(
    nameOrSignature: "getAnonymousRecord"
  ): TypedContractMethod<
    [uuid: string],
    [
      [bigint, bigint, boolean] & {
  ...
  >;
  getFunction(
    nameOrSignature: "getIdentityRecord"
  ): TypedContractMethod<
    [uuid: string],
    [
      [bigint, bigint, bigint, string, bigint, boolean] & {
  ...
  >;
  getFunction(
    nameOrSignature: "getPseudonymousRecord"
  ): TypedContractMethod<
    [uuid: string],
    [
      [bigint, bigint, string, bigint, boolean] & {
  ...
  getFunction(
    nameOrSignature: "identityRecords"
  ): TypedContractMethod<
    [arg0: string],
    [
      [bigint, bigint, bigint, string, bigint, boolean] & {
  ...
  >;
  getFunction(
    nameOrSignature: "pseudonymousRecords"
  ): TypedContractMethod<
    [arg0: string],
    [
      [bigint, bigint, string, bigint, boolean] & {
